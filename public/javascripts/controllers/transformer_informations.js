...
$(document).ready(function() {
  ...
  function setSystemFaultLevelHvMva() {
    var busVoltageHv = parseFloat(
      ...
      var systemFaultLevelHv = parseFloat($('#transformer_information_system_fault_level_hv').val());
    ...
    function setSystemFaultLevelLvMva() {
      var busVoltageLv = parseFloat(
        ...
        var systemFaultLevelLv = parseFloat($('#transformer_information_system_fault_level_lv').val());
        if (!isNaN(busVoltageLv) && !isNaN(systemFaultLevelLv)) {
          var systemFaultLevelLvMva = 1.732 * busVoltageLv * systemFaultLevelLv; 
          $('#transformer_information_system_fault_level_lv_mva').val(systemFaultLevelLvMva); 
