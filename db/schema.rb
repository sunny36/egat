...
ActiveRecord::Schema.define(:version => 20100905092458) do
  ...
  create_table "conservator_tank", :force => true do |t|
    ...
    t.datetime "test_date"
    t.string   "work_order"
    t.decimal  "breather_maintank"
    t.decimal  "breather_oltc"
    t.decimal  "corrosion_maintank"
    t.decimal  "corrosion_oltc"
    t.decimal  "jel_color_maintank"
    t.decimal  "jel_color_oltc"
    t.decimal  "oil_level_maintank"
    t.decimal  "oil_level_oltc"
    t.decimal  "oilfail_maintank"
  ...
  create_table "general_condition", :force => true do |t|
    ...
    t.datetime "test_date"
    t.string   "work_order"
    t.decimal  "animal_protect"
    t.decimal  "foundation"
    t.decimal  "ground_connector"
    t.decimal  "percentload"
    t.decimal  "perform_type"
    t.decimal  "sound"
    t.decimal  "transformer"
    t.decimal  "vibration"
  ...
  create_table "importance_indices", :force => true do |t|
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "bus_voltage",           :limit => 0
    t.integer  "bus_voltage_hv_id",     :limit => 0
    t.integer  "bus_voltage_lv_id",     :limit => 0
  ...
  create_table "lightning_arrester", :force => true do |t|
    ...
    t.datetime "test_date"
    t.string   "work_order"
    t.decimal  "ground_connector_hv"
    t.decimal  "ground_connector_lv"
    t.decimal  "ground_connector_tv"
    t.decimal  "leakage_current_hv"
    t.decimal  "leakage_current_lv"
    t.decimal  "leakage_current_tv"
    t.decimal  "perform_type"
    t.decimal  "pocelain_clean_hv"
    t.decimal  "pocelain_clean_lv"
    t.decimal  "pocelain_clean_tv"
    t.decimal  "pocelain_status_hv"
    t.decimal  "pocelain_status_lv"
    t.decimal  "pocelain_status_tv"
    t.decimal  "transformer"
  end
  ...
  create_table "ngr", :force => true do |t|
    ...
    t.datetime "test_date"
    t.string   "work_order"
    t.decimal  "base_status"
    t.decimal  "ground_connector"
    t.decimal  "ngr_status"
    t.decimal  "perform_type"
    t.decimal  "pocelain_clean"
    t.decimal  "transformer"
  end
  ...
  create_table "oltc_control_cab", :force => true do |t|
    ...
    t.string   "work_order"
    t.decimal  "animal"
    t.decimal  "control_humidity"
    t.decimal  "corrosion"
    t.decimal  "perform_type"
    t.decimal  "pragen"
    t.decimal  "transformer"
    t.decimal  "wiring_control"
  end
  ...
  create_table "report", :force => true do |t|
    ...
    t.string   "up_time"
    t.string   "work_order"
    t.decimal  "ab_environment"
    t.decimal  "damage_data"
    t.decimal  "environment"
    t.decimal  "equipment"
    t.decimal  "failure_mode"
    t.decimal  "maintenance"
    t.decimal  "real_cause"
    t.decimal  "station"
    t.decimal  "transformer"
  end
  ...
  create_table "transformer", :force => true do |t|
    ...
    t.decimal  "first_substation"
    t.decimal  "manufacturing"
    t.decimal  "oltc_manufacturing"
    t.decimal  "oltc_model"
    t.decimal  "status"
    t.decimal  "winding_type"
    t.integer  "brand_id"
  end
  ...
  create_table "visual_bushing", :force => true do |t|
    ...
    t.datetime "test_date"
    t.string   "work_order"
    t.decimal  "oil_color_hv"
    t.decimal  "oil_color_lv"
    t.decimal  "oil_color_tv"
    t.decimal  "oil_fail_hv"
    t.decimal  "oil_fail_lv"
    t.decimal  "oil_fail_tv"
    t.decimal  "oil_level_hv"
    t.decimal  "oil_level_lv"
    t.decimal  "oil_level_tv"
    t.decimal  "perform_type"
    t.decimal  "pocelain_clean_hv"
    t.decimal  "pocelain_clean_lv"
    t.decimal  "pocelain_clean_tv"
