OltcDielectricPropertyFactor.delete_all
ActiveRecord::Base.connection.execute('ALTER TABLE oltc_dielectric_property_factors AUTO_INCREMENT = 1')
...
OltcDielectricPropertyFactor.seed(
