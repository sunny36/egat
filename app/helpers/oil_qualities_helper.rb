module OilQualitiesHelper
  def hi_factor_color
    ...
    color = oil_quality.hi_factor_color(@insulating_oil, @oil_contamination, :oil_quality)
  ...
  def percent_contamination_factor
    oil_quality = OilQuality.new
    number_with_precision(oil_quality.percent_contamination_factor(@insulating_oil, @oil_contamination),
                          :precision => 2)
  end
end
